...
<head>
    ...
    <!-- Google Tag Manager -->
    <script>
    !function(e,t,a,n,g){e[n]=e[n]||[],e[n].push({"gtm.start":(new Date).getTime(),event:"gtm.js"});var m=t.getElementsByTagName(a)[0],r=t.createElement(a);r.async=!0,r.src="https://www.googletagmanager.com/gtm.js?id=GTM-T5NGXK7",m.parentNode.insertBefore(r,m)}(window,document,"script","dataLayer");window.dataLayer=window.dataLayer||[],window.dataLayer.push({userId:"cookiesId"}),dataLayer.push({event:"playvideo",event_category:"{dymanic}",event_action:"{dymanic}",event_label:"{dymanic}"}),dataLayer.push({event:"ticket",event_category:"{dymanic}",event_action:"Ticket",event_label:"Secure Your Ticket"}),dataLayer.push({event:"gallery",event_category:"{dymanic}",event_action:"Gallery",event_label:"{dymanic}"}),dataLayer.push({event:"lineup",event_category:"{dymanic}",event_action:"Lineup",event_label:"{dymanic}"}),dataLayer.push({event:"ticketbox",event_category:"{dymanic}",event_action:"Ticket",event_label:"{dymanic}"}),dataLayer.push({event:"gallery",event_category:"{dymanic}",event_action:"Gallery",event_label:"{dymanic}"}),dataLayer.push({event:"map",event_category:"{dymanic}",event_action:"Map",event_label:"Click on Map"});
    </script>
...
<body class="hidden">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T5NGXK7" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
